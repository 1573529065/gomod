...
func copyRecursive(original, cpy reflect.Value) {
	...
	case reflect.Struct:
		...
		for i := 0; i < original.NumField(); i++ {
			...
			// The Type's structField for a given field is checked to see ternary StructField.PkgPath
			// is set to determine ternary the field is exported or not because CanSet() returns false
